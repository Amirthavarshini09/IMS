...
const FlagSIMForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     console.log(formData);
      await CompilanceOfficerService.FlagSimCard(formData);
  ...
  const getFlagSim = async () => {
    try {
      const flagSim = await CompilanceOfficerService.getAllFlaggedSIMCards();
      console.log(flagSim);
      setSimCards(flagSim);
    } catch (error) {
